...
#from .leffOverlay import moverOverlay
from .OverlayTemplate import OverlayTemplate
import math
...
class VulkanManager:
    ...
    def onKeyPress(self, obj, event):
        ...
        return self.events.iren.GetKeySym()
    ...
    def selectActorById(self, id):
        ...
        if overlayNeeded and not self.moverOverlay.overlayEnabled:
    ...
    def onLeftButtonPress(self, obj, event):
        ...
        return self.events.getEventPosition()
